...
var (
	...
	ErrOnlyOwnerCanSendMessaage     = errors.New("Only owner can send message in channel")
	ErrOnlyOwnerCanChangeAvatar     = errors.New("Only owner can change avatar of channel")
	ErrOnlyOwnerCanChangeTitle      = errors.New("Only owner can change title of channel")
)
